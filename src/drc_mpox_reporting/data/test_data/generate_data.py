...
aires_sante = gpd.read_file(
    aires_sante_shp_dir
).PCODE.unique()  # not sure if this is the right column
...
data = pd.DataFrame(
    {
        ...
        "DateoOfNotification": date_notification_values,
        "CaseClassification": case_classification_values,
        "Status": status_values,
        "DateOfDeath": date_deceased_values,
        "Sex": sex_values,
        "Age": age_values,
        "AgeMonth": age_months_values,
    }
)
