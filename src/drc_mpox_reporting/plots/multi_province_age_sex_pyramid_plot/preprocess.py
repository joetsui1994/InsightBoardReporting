...
def preprocess_multi_province_pyramid_data(data, parameters):
    ...
    plot_data = (
        plot_data.groupby(["age_group", sex_col, "province"])
        .size()
    ...
    all_combinations = pd.MultiIndex.from_product(
        [
            plot_data["age_group"].unique(),
            plot_data[sex_col].unique(),
            plot_data["province"].unique(),
        ],
    ...
    plot_data_complete = (
        plot_data.set_index(["age_group", sex_col, "province"])
