...
def plot_multi_week_zone_sante_map_matplotlib(geo_data, parameters):
    ...
    for i, date in enumerate(dates):
        ...
        geo_data_merged = zones_sante_gdf.merge(
            geo_data_filtered,
            left_on=SHAPEFILE_COLUMN,
            right_on="zones_sante",
            how="left",
        )
        ...
        zones_sante_gdf.boundary.plot(
            ax=axs[i], color="white", linewidth=0.3, alpha=0.4
        )
